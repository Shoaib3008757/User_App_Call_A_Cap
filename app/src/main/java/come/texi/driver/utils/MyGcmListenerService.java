...
//        System.out.println("Indiaries >>"+message);
        ...
        System.out.println("GCM Indiaries PushNotification Message >>"+message);
...
//        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                    ...
                    .setContentTitle(URLDecoder.decode(getResources().getString(R.string.app_name), "UTF-8"))
...
//            }
    ...
    public static void setBadge(Context context) {
        ...
        System.out.println("Local Class Name >>"+cn.getClassName());
        Intent intent1 = new Intent(cn.getClassName());
